...
const page = () => {
  return (
    <>
      ...
      <ResultsSection />
      <SubscribeSection />
      <div className="max-w-[1440px] px-6 md:px-12 my-24">
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-sm text-neutral-500">info@gmail.com</p>
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-6/12 md:px-3 lg:mb-12 lg:w-full lg:px-6 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500"> (01) 85642314</p>
                    </div>
                  </div>
                </div>
                <div className="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-neutral-500"> +977 9813852012</p>
                    </div>
                  </div>
                </div>
              </div>
    ...
    <section className="py-14 lg:py-24 relative z-0 bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
        <h1 className="max-w-2xl mx-auto text-center font-manrope font-bold text-4xl  text-gray-900 mb-5 md:text-5xl md:leading-normal">
          Control your Health with
          <span className="text-indigo-600"> this platform</span>
        </h1>
