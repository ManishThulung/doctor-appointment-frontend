...
const HospitalCard = () => {
  return (
    <div className="min-w-[300px] max-w-sm bg-white shadow-lg rounded-lg overflow-hidden my-4 cursor-pointer">
      ...
      <img
        ...
        alt="avatar"
      />
      <div className="flex w-fit items-center px-6 py-3 bg-gray-900 absolute bottom-0 right-0">
